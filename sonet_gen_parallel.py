...
#TODO: Check if overal Sonnet_crown structure works
#TODO: Test generation of sonnet crown using maybe just build_group_TEST
...
class Sonnet_crown:
    ...
    def generate_single_sonnet(self, line):
        ...
        self.subsonnets[line] = Poem(self.pattern, start_line, end_line)

    def generate_full(self):
        """Generate a full sonnet crown"""
        for i in range(self.line_number):
            self.generate_single_sonnet(i)
    ...
    def print_full(self):
        ...
        for i in range(self.line_number):
            if self.subsonnets[i] == None:
                ...
                # Can you actually just do it like this?
...
class Poem:
    ...
    def __init__(self, pattern='A7A7B7B7', *args):
        self.config = config.Config()
        is_test = self.config.is_test
        ...
        self.poem = self.generate_poem(pattern, is_test, *args)

    def generate_poem(self, pattern, is_test, *args):
...
#poem = Poem('ABAB7676','This is a nest','Nothing will bend')
#poem.print_poem()
sonnet_crown = Sonnet_crown('ABAB7676')
